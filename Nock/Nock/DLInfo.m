...
//  Nock
//
//  Created by Jannie Theron on 2014/05/28.
...
-(instancetype)init{
    if (self = [super init]){
        ...
        SKLabelNode *header = [[SKLabelNode node]initWithFontNamed:_gameState.currentTheme.font];
        header.text = @"Rules";
        header.fontSize = 50;
        ...
        SKLabelNode *line1 = [[SKLabelNode node]initWithFontNamed:_gameState.currentTheme.font];
        ...
        SKLabelNode *line2 = [[SKLabelNode node]initWithFontNamed:_gameState.currentTheme.font];
        ...
        SKLabelNode *line3 = [[SKLabelNode node]initWithFontNamed:_gameState.currentTheme.font];
        ...
        SKLabelNode *line4 = [[SKLabelNode node]initWithFontNamed:_gameState.currentTheme.font];
        ...
        SKLabelNode *myAd = [[SKLabelNode node]initWithFontNamed:_gameState.currentTheme.font];
        ...
        SKLabelNode *myAd2 = [[SKLabelNode node]initWithFontNamed:_gameState.currentTheme.font];
        myAd2.text = @"";
